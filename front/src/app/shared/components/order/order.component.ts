...
import {Order, OrderStatus, PaymentStatus} from '../../models/order/Order';
...
export class OrderComponent implements OnInit {
    ...
    async getOrder() {
        ...
        let {title, description, datetimeIn, datetimeOut, orderStatus, paymentStatus, client} = this.order$();

        this.formOrder.setValue({
            title, description, datetimeIn, datetimeOut, orderStatus, paymentStatus, client
        });
    }
